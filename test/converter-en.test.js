...
test('it generates correct string for given number', t => {
	...
	t.is(englishSpellingGenerator(27317644), 'twenty-seven million three hundred seventeen thousand six hundred forty-four');
...
test('should throw error for incorrect (NaN) argument provided', t => {
	...
	t.throws(() => { englishSpellingGenerator('abc'); }, null, 'Incorrect number provided');
	t.throws(() => { englishSpellingGenerator('$%!'); }, null, 'Incorrect number provided');
	t.throws(() => { englishSpellingGenerator('1xas13'); }, null, 'Incorrect number provided');
	t.throws(() => { englishSpellingGenerator('1234xaf'); }, null, 'Incorrect number provided');
